...
CREATE TABLE provisioning_credentials (
  ...
  CONSTRAINT unique_provider_per_organization UNIQUE (organization_id, provider)
);

CREATE INDEX provisioning_credentials_organization_id ON provisioning_credentials
  (organization_id);
