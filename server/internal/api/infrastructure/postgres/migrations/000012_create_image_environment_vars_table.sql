...
CREATE TABLE image_environment_vars (
  id BIGSERIAL PRIMARY KEY, deployment_id BIGINT NOT NULL REFERENCES image_deployments (deployment_id) ON DELETE CASCADE, name TEXT NOT NULL, value TEXT NOT NULL, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
