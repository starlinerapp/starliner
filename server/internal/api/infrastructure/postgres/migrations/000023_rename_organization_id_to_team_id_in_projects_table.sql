...
ALTER TABLE projects
  ADD CONSTRAINT projects_team_id_fkey FOREIGN KEY (team_id) REFERENCES teams (id) ON
    DELETE CASCADE;
...
ALTER TABLE projects
  ADD CONSTRAINT projects_organization_id_fkey FOREIGN KEY (team_id) REFERENCES
