...
INSERT INTO environments (name, slug, namespace, project_id)
    VALUES ($1, $2, $3, $4)
RETURNING
    *;

-- name: CreateEnvironmentWithConnectedBranch :one
INSERT INTO environments (name, slug, namespace, project_id, connected_branch)
    VALUES ($1, $2, $3, $4, $5)
RETURNING
    *;
...
INSERT INTO preview_environments (environment_id, github_repository_id, pr_number)
    SELECT
        id,
        $6,
        $7
