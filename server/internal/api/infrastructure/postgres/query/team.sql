-- name: CreateTeam :one
INSERT INTO teams (slug, organization_id)
    VALUES ($1, $2)
RETURNING
    *;
...
INSERT INTO team_repositories (team_id, github_repo_id, repo_name, github_app_id)
    VALUES ($1, $2, $3, $4)
ON CONFLICT (team_id, github_repo_id)
    DO NOTHING;
...
WHERE
    team_clusters.team_id = $1;

-- name: AssignTeamCluster :exec
INSERT INTO team_clusters (team_id, cluster_id)
    VALUES ($1, $2)
ON CONFLICT (team_id, cluster_id)
    DO NOTHING;
