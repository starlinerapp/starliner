...
INSERT INTO provisioning_credentials (organization_id, provider, secret)
    VALUES ($1, $2, $3)
...
WITH new_invite AS (
INSERT INTO organization_invites (organization_id, email, expires_at)
        VALUES ($1, $2, $3)
    RETURNING
        *)
    SELECT
