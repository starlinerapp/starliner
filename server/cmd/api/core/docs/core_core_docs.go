    ...
    "paths": {
        ...
        "/organizations/{id}/runners": {
            "get": {
                ...
                "operationId": "getOrganizationRunners",
                "parameters": [
                    {
                        "type": "string",
                        "description": "User ID",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/response.Runner"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/response.TeamCluster"
                            }
                        }
                    }
                }
...
// SwaggerCoreInfocore holds exported Swagger Info so clients can modify it
var SwaggerCoreInfocore = &swag.Spec{
	Version:          "1.0",
	Host:             "",
	BasePath:         "",
	Schemes:          []string{},
	Title:            "Starliner Core API",
	Description:      "",
	InfoInstanceName: "core",
	SwaggerTemplate:  docTemplatecoreCore,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerCoreInfocore.InstanceName(), SwaggerCoreInfocore)
}
