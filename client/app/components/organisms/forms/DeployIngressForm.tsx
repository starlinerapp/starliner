    ...
    <div className="relative">
      {showRemove && (
        <button
          type="button"
          onClick={onRemove}
          className="absolute top-3.75 -left-2 z-10 flex h-4 w-4 cursor-pointer items-center justify-center rounded border-[1.5px] border-mauve-6 bg-white text-mauve-7 hover:border-violet-9 hover:text-violet-9"
        >
          <Minus className="stroke-3" />
        </button>
      )}

      <div className="relative flex flex-col gap-1 border-mauve-6 border-l-2 pl-6">
        <div className="flex gap-2">
          <div className="absolute -left-0.5 h-6 w-6 rounded-bl-md border-mauve-6 border-b-2 border-l-2" />
          <div className="flex w-full min-w-0 flex-col gap-1">
            <div className="flex w-full min-w-0 items-center gap-1">
              <input
                className="min-w-24 flex-1 rounded-md border border-mauve-6 bg-gray-2 p-2 text-sm shadow-[inset_0_1px_2px_rgba(0,0,0,0.12)] placeholder:text-mauve-11"
                type="text"
              ...
              />
              <span className="truncate text-mauve-11 text-sm">
                {hostSuffix}
              </span>
            </div>
            {errorMessage && (
        ...
        <div className="relative flex flex-col gap-3 border-mauve-6 border-l-2 pl-6">
            ...
            <div key={path.id} className="relative flex flex-col gap-1">
              {pathIndex > 0 && (
                <button
                  ...
                  className="absolute top-3.75 -left-8 z-10 flex h-4 w-4 cursor-pointer items-center justify-center rounded border-[1.5px] border-mauve-6 bg-white text-mauve-7 hover:border-violet-9 hover:text-violet-9"
                >
                  <Minus className="stroke-3" />
                </button>
              )}

              <div className="absolute -left-6.5 h-6 w-6 rounded-bl-md border-mauve-6 border-b-2 border-l-2" />

              <div className="flex w-full gap-1">
                <div className="relative min-w-24">
                  <select
                    className="h-full w-full appearance-none rounded-md border border-mauve-6 bg-gray-2 px-2 py-1 text-sm shadow-[inset_0_1px_2px_rgba(0,0,0,0.12)]"
                ...
                <input
                  className="w-full min-w-24 rounded-md border border-mauve-6 bg-gray-2 p-2 text-sm shadow-[inset_0_1px_2px_rgba(0,0,0,0.12)] placeholder:text-mauve-11"
                  type="text"
                  placeholder="Path*"
              ...
              <div className="relative ml-1 flex flex-col gap-1 border-mauve-6 border-l-2 pl-6">
                <div className="absolute -left-0.5 h-6 w-6 rounded-bl-md border-mauve-6 border-b-2 border-l-2" />

                <div className="relative min-w-48">
                  <select
                    className="h-full w-full appearance-none rounded-md border border-mauve-6 bg-gray-2 p-2 text-sm shadow-[inset_0_1px_2px_rgba(0,0,0,0.12)]"
